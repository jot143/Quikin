...
function Continue() {
  ...
  if (activeTab.attr("id") === "create_product_tab") {
    ...
    celement = $(
      '.create_product_cards .card[data-mockup-id="' +
        window.selected_mockup_product_id +
        '"]'
    );
    selectCard(celement);
...
function populateImageToProducts(productData) {
  ...
  Object.values(productData).forEach((product) => {
    const productCard = `
            <div class="col-lg-3 col-md-3 col-sm-6 col-6 mt-2 create_product_cards">
                <div class="card" data-mockup-id="${product.mockup_id}">
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-text text-center" style="font-size:14px;font-weight:600; margin-top: 15px;">
