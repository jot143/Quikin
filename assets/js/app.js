...
(function () {
        ...
        element.addEventListener("click", function (e) {
          ...
          if (
            ...
            twoColumnItem.length > 0
              ? twoColumnItem[0].classList.remove("twocolumn-item-show")
              : "";
  ...
  function menuItem(e) {
    if (e.target && e.target.matches("a.nav-link span")) {
      if (
        elementInViewport(e.target.parentElement.nextElementSibling) == false
      ) {
        ...
        elementInViewport(e.target.parentElement.nextElementSibling) == true
      ) {
    ...
    if (currentPath) {
      ...
      if (a) {
        ...
        if (
          ...
          a.closest(".collapse.menu-dropdown").parentElement.classList.add(
            "twocolumn-item-show"
          );
      ...
      function emptyNotification() {
        Array.from(
          ...
          if (elem.querySelectorAll(".notification-item").length > 0) {
            ...
            var emptyNotificationElem = elem.querySelector(
    ...
    switch (isLayoutAttributes) {
      case isLayoutAttributes:
        switch (isLayoutAttributes["data-layout"]) {
          ...
          default:
            if (
              sessionStorage.getItem("data-layout") == "vertical" &&
        ...
        switch (isLayoutAttributes["data-sidebar-size"]) {
          ...
          default:
            if (sessionStorage.getItem("data-sidebar-size") == "sm") {
              ...
              sessionStorage.getItem("data-sidebar-size") == "sm-hover"
            ) {
              document.documentElement.setAttribute(
                "data-sidebar-size",
                "sm-hover"
        ...
        switch (isLayoutAttributes["data-sidebar-image"]) {
          ...
          default:
            if (
              ...
              sessionStorage.getItem("data-sidebar-image") == "img-1"
            ) {
              sessionStorage.setItem("data-sidebar-image", "img-1");
              getElementUsingTagname("data-sidebar-image", "img-1");
              document.documentElement.setAttribute(
              ...
              sessionStorage.getItem("data-sidebar-image") == "img-2"
            ) {
              sessionStorage.setItem("data-sidebar-image", "img-2");
              getElementUsingTagname("data-sidebar-image", "img-2");
              document.documentElement.setAttribute(
              ...
              sessionStorage.getItem("data-sidebar-image") == "img-3"
            ) {
              sessionStorage.setItem("data-sidebar-image", "img-3");
              getElementUsingTagname("data-sidebar-image", "img-3");
              document.documentElement.setAttribute(
              ...
              sessionStorage.getItem("data-sidebar-image") == "img-4"
            ) {
              sessionStorage.setItem("data-sidebar-image", "img-4");
              getElementUsingTagname("data-sidebar-image", "img-4");
              document.documentElement.setAttribute(
  ...
  function getElementUsingTagname(ele, val) {
    Array.from(document.querySelectorAll("input[name=" + ele + "]")).forEach(
      function (x) {
